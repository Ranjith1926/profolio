        ...
        <div className="p-8">
          ...
          {project.liveUrl && (
            <a
              ...
              className="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-gradient-primary text-white rounded-full font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-primary/30 hover:-translate-y-0.5"
            >
              <span>Live Demo</span>
              <svg
